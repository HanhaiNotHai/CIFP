...
class TinyDINOv3(nn.Module):
    """Explicit synthetic-smoke backbone; never used as a pretrained-model fallback."""
    ...
    def __init__(
        ...
        *,
        ...
        self.patch_embeddings = nn.Conv2d(3, hidden_size, kernel_size=patch_size, stride=patch_size)
